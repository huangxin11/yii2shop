    ...
    <div class="logo w1210">
        ...
        <div class="search fl">
            <div class="search_form">
                ...
                <form action="<?=\yii\helpers\Url::to(['index/search'])?>" method="get" class="fl">
                    <input type="text" name="serarch" class="txt" value="请输入商品关键字" /><input type="submit" class="btn" value="搜索" />
                </form>
...
<div class="list w1210 bc mt10">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<a href="<?=\yii\helpers\Url::to(['index/index'])?>">首页</a> > <a href="">电脑、办公</a></h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <!-- 分页信息 start -->
        <div class="page mt20" style="margin-right: 500px">
            <?php
