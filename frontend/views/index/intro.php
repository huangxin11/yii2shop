    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=Yii::$app->params['backend_domain'].$good->logo?>" width="350px" height="350px" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=Yii::$app->params['backend_domain'].$good->logo?>" width="350px" height="350px" alt="" />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
