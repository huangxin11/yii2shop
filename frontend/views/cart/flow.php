...
<div class="mycart w990 mt10 bc">
    ...
    <table>
        ...
        <tr data_id="<?=$model->id?>">
            <td class="col1"><a href=""><img src="<?=Yii::$app->params['backend_domain'].$model->logo?>" alt="" width="100px" height="100px" /></a>  <strong><a href=""><?=$model->name?></a></strong></td>
...
<script type="text/javascript">
    $("table").on('click','.del',function () {
        if (confirm("是否确认删除")){
            ...
            var that = this;
            $.post('/cart/ajax-cart?type=del',{goods_id:goods_id},function (data) {
                if(data == 'success'){
