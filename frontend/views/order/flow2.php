...
<div class="fillin w990 bc mt15">
    ...
    <form action="<?=\yii\helpers\Url::to(['order/order'])?>" method="post" name="order">
    <div class="fillin_bd">
        <!-- 收货人信息  start-->
        <div class="address">
            <h3>收货人信息</h3>
            <div class="address_info">
                <p>
                    ...
                    <input type="radio" value="<?=$address->id?>" name="address"/><?=$address->name?> <?=$address->phone?>  <?=$address->province?> <?=$address->city?> <?=$address->county?> </p>
                <?php endforeach;?>
...
<!--                </form>-->
        ...
        <div class="goods">
            ...
            <table>
                ...
                <tr>
                    <td class="col1"><a href=""><img src="<?=Yii::$app->params['backend_domain'].$model->logo?>" alt="" /></a>  <strong><a href=""><?=$model->name?></a></strong></td>
    ...
    <div class="fillin_ft">
        <a href="javascript:;" class="add"><span>提交订单</span></a>
...
<script type="text/javascript">
    $(".add").click(function () {
        $.post('<?=\yii\helpers\Url::to(['order/order'])?>',$("form").serialize(),function (data) {
                if(data == 'success'){
                    $(location).attr('href', '<?=\yii\helpers\Url::to(['order/view'])?>');
                }else {
                    alert(data);
                }
        });
